 ...
 */
    //***I Made some changes to this page, they are all morked with /*connor*/**//
...
window.onbeforeunload = function(){
   if(!answered){
     req = new XMLHttpRequest();
     req.open("GET", "http://www.connordev.com/userballot/answer.php?question="+ $ub.selectedMessage.text +"&answer=none&siteId=" + $ub.siteId);
     req.send();
    return ;;
   }
   else{
...
/*connor*/
                answered = true;
                req = new XMLHttpRequest();
              	req.open("GET", "http://www.connordev.com/userballot/answer.php?question="+ $ub.selectedMessage.text +"&answer=yes&siteId=" + $ub.siteId);
                req.send();
/*connor*/
...
/*connor*/
                answered = true;
                req = new XMLHttpRequest();
              	req.open("GET", "http://www.connordev.com/userballot/answer.php?question="+ $ub.selectedMessage.text +"&answer=no&siteId=" + $ub.siteId);
                req.send();
/*connor*/
