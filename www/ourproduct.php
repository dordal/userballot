		    ...
		    <div class="container" style="margin-bottom: 100px;">
                ...
                <div class="sectionContainer" style="margin-top:20px">
                    ...
                    <div class="right-text">
                        ...
                        <p><strong>UserBallot</strong> is a new one-touch feedback gathering tool based around yes or no questions that lets you get real time answers from more of your customers than ever before. All you do is copy and paste a few lines of code into your website!</p>
                    </div>
                </div>
