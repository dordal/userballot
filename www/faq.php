    ...
    <div class="page-wrap" style="margin-top: 50px">        
	    <div class="masthead">
            <div class="faq">
                ...
                <h1>Why only yes/no formatted questions?</h1>
                ...
                <h1>Which questions will my customers see?</h1>
                ...
                <h1>What kind of results will I receive from my site visitors?</h1>
                ...
                <h1>Why would I use UserBallot compared to other feedback tools?</h1>
