...
$ub.displayMessage = function() {
	...
	var fragment = create('<div id="ub-container" style="z-index: 1000; padding: 10px; position: fixed; bottom: 0; left: 0; right: 0; background-color: #3498DB; padding: 20px 10px; color: #ffffff; font-size: 18px;"><div style="position: relative; max-width: 980px; margin: 0 auto;""><img src="http://app.userballot.com/img/question-flag.png" height="32" style="position: absolute; right: 0;" /><span style="text-align: left; padding: 0 20px;">' + $ub.selectedMessage.text + '</span><span style="position: absolute; right: 0;"><a style="text-align: center; background-color: #02c3e5; color: #ffffff; text-decoration: none; padding: 3px 10px; width: 60px; display: inline-block;" href="" id="ub-yes">Yes</a> <a style="text-align: center; background-color: #02c3e5; color: #ffffff; text-decoration: none; padding: 3px 10px; width: 60px; display: inline-block;" href="" id="ub-no">No</a></span></div></div>');
